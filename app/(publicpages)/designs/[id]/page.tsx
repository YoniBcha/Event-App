...
export default function DesignPage() {
  ...
  return (
    <div className="flex flex-col gap-6 sm:p-4 p-1">
      ...
      {/* Image Grid */}
      <div className="grid grid-cols-1 mb-3 mx-auto max-sm:w-full lg:w-[75%] max-md:w-[85%] max-lg:w-[80%]  min-[350px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full sm:px-4">
