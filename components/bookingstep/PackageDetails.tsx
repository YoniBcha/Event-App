    ...
    >
      <div className="flex-grow flex flex-col justify-center items-center w-full h-full mt-6 md:mt-0">
        ...
        {isLoading ? (
          ...
          <motion.div
            className="flex flex-col gap-3 md:flex-row bg-secondary w-full max-[550px]:w-full max-lg:w-4/5 md:w-[85%] lg:w-3/4 h-fit max-md:bg-transparent p-3 rounded-xl"
